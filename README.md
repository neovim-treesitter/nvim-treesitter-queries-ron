# nvim-treesitter-queries-ron

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ron/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ron/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ron**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-ron",
...
- [ ] Changes are scoped to `ron` — do not include files for other languages
